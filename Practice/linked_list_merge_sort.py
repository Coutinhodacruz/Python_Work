...
def merge_sort(linked_list):
    ...
    - Recursively divide the linked list ino sublist containing a single node
...
def merge(left, right):
    ...
    # Add a fake head that is discard later
    merged.add(0)
    ...
    while left_head or right_head:
        ...
        # Add the tail node from left to merged linked list
            ...
            # Call next on lest to set loop condition to False
            left_head = left_head.next_node
        else:
            # Add at either tail node
